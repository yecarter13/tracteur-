        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
            <div>
                ...
                <p class="text-field-400 text-sm leading-relaxed mb-4">
                    Spécialiste de la pièce de tracteur neuve et garantie. Plus de 60 ans d'expertise au service des agriculteurs, concessionnaires et ateliers, avec livraison partout dans le monde.
                </p>
        ...
        <div class="border-t border-field-800 pt-8">
            <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                ...
                <p class="text-field-600 text-xs">
                    &copy; {{ date('Y') }} {{ $company_name }} — Vente de pièces de tracteur partout dans le monde. Tous droits réservés.
                </p>
            </div>
        </div>
    </div>
